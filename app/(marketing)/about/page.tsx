  ...
  return (
    <>
      <PageHeader
        badge="About XCS"
        badgeColor="accent"
        title="Building Ethical Cloud Infrastructure"
        description="We build Shariah-compliant cloud infrastructure for the decentralized web. No fluff, just uptime and ethics."
      />
          ...
          <div className="flex flex-col items-center gap-16 lg:flex-row lg:gap-20">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="mt-4 font-display text-3xl font-bold text-foreground md:text-4xl text-balance">
                The Foundation of SidraChain
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                We build the infrastructure that keeps SidraChain running.
                Secure, scalable, and decentralized, without the complexity.
                Our goal is simple: ensure your applications stay online,
                compliant, and fast.
              </p>
              <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                We provide the backend muscle for the decentralized web.
                From cloud hosting to data management, everything we do is
                strictly Shariah-compliant. No compromises on ethics,
              ...
              <div className="flex flex-col gap-12">
                {milestones.map((milestone, i) => (
                  <div
                    ...
                    className={`relative flex flex-col gap-4 pl-12 md:w-1/2 md:pl-0 ${i % 2 === 0
                      ? "md:pr-12 md:self-start md:text-right"
                      : "md:pl-12 md:self-end"
                      }`}
                  >
                    <div
                      className={`absolute top-1 left-2.5 h-3 w-3 rounded-full border-2 border-primary bg-background md:left-auto ${i % 2 === 0
                        ? "md:right-[-6.5px]"
                        : "md:left-[-6.5px]"
                        }`}
                    />
